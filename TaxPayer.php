...
class TaxPayer 
{
    ...
    if( $annualIncome <= INCOME_PORTION_1 ) {
        ...
        if( $firstRemainder <= INCOME_PORTION_2 ) {
            ...
            if( $secondRemainder <= INCOME_PORTION_3 ) {
                ...
                if( $thirdRemainder <= INCOME_PORTION_4 ) {
                    ...
                    if( $fourthRemainder <= INCOME_PORTION_5 ) {
